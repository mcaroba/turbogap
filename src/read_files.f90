...
!      i2 = len(trim(keyword))
         ...
         if (keyword_first == '#' .or. keyword_first == '!' .or. keyword == 'pot_file' .or. keyword == 'n_species') then
            ...
            backspace (10)
            read (10, *, iostat=iostatus) cjunk, cjunk, (params%mc_planes(nw), nw=1, 4*params%mc_n_planes)

         else if (keyword == 'mc_max_dist_to_planes') then
            backspace (10)
            read (10, *, iostat=iostatus) cjunk, cjunk, (params%mc_max_dist_to_planes(nw), nw=1, params%mc_n_planes)

         else if (keyword == 'mc_planes_restrict_to_polyhedron') then
            backspace (10)
            read (10, *, iostat=iostatus) cjunk, cjunk, params%mc_planes_restrict_to_polyhedron
...
! do experimental
            ...
            backspace (10)
            read (10, *, iostat=iostatus) cjunk, cjunk, params%xps_e_min

         else if (keyword == 'xps_e_max') then
            backspace (10)
            read (10, *, iostat=iostatus) cjunk, cjunk, params%xps_e_max
