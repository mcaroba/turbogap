...
if ( abs(rcut_2b) < 1.d-10 ) then
          ...
          do i3 = 1, n_neigh(i)
            ...
            if (rjs(n_tot+k_i) .le. 2.d0*rcut_mbd+rcut_loc ) then
              ...
              do j3 = 1, n_neigh(i)
                ...
                if ( rjs(n_tot+k_j) .le. 2.d0*rcut_mbd+rcut_loc ) then
                  if (i3 .ne. j3) then
                    xyz_j = xyz(:,n_tot+k_j)/Bohr
              ...
              if ( rjs(n_tot+k_i) .le. rcut_loc-r_buf_loc ) then
                ...
                r0_ii_SCS(k2) = r0_ii_mbd(k2) * (a_iso(r,2)/neighbor_alpha0_mbd(k2))**(1.d0/3.d0) * &
                            (1.d0 - 10.d0 * rb**3 &
                               ...
                               - 15.d0 * rb**4 &
                               + 6.d0 * rb**5)
              else if ( rjs(n_tot+k_i) > rcut_loc .and. rjs(n_tot+k_i) .le. 2.d0*rcut_mbd+rcut_loc ) then
                      ...
                      if ( rjs(n_tot+k_j) .le. rcut_loc-r_buf_loc ) then
                        ...
                        r0_ii_SCS(k2) = r0_ii_mbd(k2) * (a_iso(r,2)/neighbor_alpha0_mbd(k2))**(1.d0/3.d0) * &
                            (1.d0 - 10.d0 * rb**3 &
                               ...
                               - 15.d0 * rb**4 &
                               + 6.d0 * rb**5)
                      else if ( rjs(n_tot+k_j) > rcut_loc .and. rjs(n_tot+k_j) .le. 2.d0*rcut_mbd+rcut_loc) then
...
if ( abs(rcut_2b) < 1.d-10 ) then
              ...
              do p = 1, n_mbd_sites
                ...
                else if ( rjs_0_mbd(k2) > rcut_loc/Bohr .and. rjs_0_mbd(k2) .le. (2.d0*rcut_mbd+rcut_loc)/Bohr ) then
                  if ( do_hirshfeld_gradients ) then
...
!                  end if
                  ...
                  do c1 = 1, 3
                    do c2 = 1, 3
                      ...
                      if ( i == 1 .and. c3 == 1 .and. p == 240 .and. q == 267 .and. c1 == 1 .and. c2 == 1 ) then
                  ...
                  if (i == i2 .or. i == j) then
                    ...
                    do c1 = 1, 3
                      do c2 = 1, 3
                        ...
                        if ( i == 1 .and. c3 == 1 .and. p == 240 .and. q == 267 .and. c1 == 1 .and. c2 == 1 ) then
                          write(*,*) "dT_LR term", dT_LR(3*(p-1)+c1,3*(q-1)+c2)
                          write(*,*) "rjs_0_mbd", rjs_mbd(k2)
                        end if
                      end do
                    end do
                  end if
...
if ( abs(rcut_2b) < 1.d-10 ) then
              ...
              do j = 1, n_freq
                ...
                do p = 1, n_mbd_sites
                  ...
                  !  do c1 = 1, 3
                  !    do c2 = 1, 3
                  !      integrand(j) = integrand(j) + AT(3*(p-1)+c1,3*(q-1)+c2,j) * G_mat(3*(q-1)+c2,3*(p-1)+c1,j)
                  !    end do
                  !  end do
                  !end do
                  end if
                    ...
                    do j3 = 2, n_mbd_neigh(p)
                      ...
                      do c1 = 1, 3
                        do c2 = 1, 3
                          ...
                          !   (omegas_mbd(j)/o_mbd(k3+1))**2) * T_LR(3*(p-1)+c1,3*(q-1)+c2) * G_mat(3*(q-1)+c2,3*(p-1)+c1,j)
                          integrand(j) = integrand(j) + AT(3*(p-1)+c1,3*(q-1)+c2,j) * G_mat(3*(q-1)+c2,3*(p-1)+c1,j)
                        end do
                      end do
                    end do
              ...
              write(*,*) "short integrand", integrand

              call cpu_time(time2)
              
              write(*,*) "G_mat construction timing", time2-time1
