...
MODULE F_B_C
    INTERFACE
!        subroutine main_csr() bind(C,name="main_csr")
!         use iso_c_binding
!         implicit none
!       end subroutine
       ...
       subroutine gpu_memset_blocking(a_d,valuetoset,n) bind(C,name="cuda_memset_blocking")
         use iso_c_binding
         implicit none
       ...
       subroutine create_cusparse_handle(cubhandle, gpu_stream)bind(C,name="create_cusparse_handle")
         use iso_c_binding
         implicit none
         type(c_ptr) :: cubhandle, gpu_stream
       end subroutine
 
       subroutine destroy_cusparse_handle(cubhandle, gpu_stream)bind(C,name="destroy_cusparse_handle")
         use iso_c_binding
         implicit none
         type(c_ptr) :: cubhandle,gpu_stream
       end subroutine
 	...
 	integer(c_int), value :: n_sites, n_sites0
       ...
       subroutine gpu_sparse_matrix_mul_kernel(dim1, dim2, n, &
                       A_CSR_d, &
                       j_CSR_d, &
                       i_CSR_d, &
                       ipointer_d, &
                       res_d, &
                       v_d, &
                       gpu_stream, cusparse_handle ) bind(c, name="gpu_sparse_matrix_mul_kernel")
               use iso_c_binding
               implicit none
               integer( c_int ), value :: dim1, dim2,  n 
               type(c_ptr), value :: A_CSR_d
               type(c_ptr), value :: j_CSR_d
               type(c_ptr), value :: i_CSR_d
               type(c_ptr), value :: ipointer_d
               type(c_ptr), value :: res_d
               type(c_ptr), value :: v_d
               type(c_ptr) :: gpu_stream
               type(c_ptr), value :: cusparse_handle
       end subroutine gpu_sparse_matrix_mul_kernel
