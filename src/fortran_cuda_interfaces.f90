...
module gpu_variables
   ...
   type gpu_neigh
      type(gpu_var_int_class) :: n_neigh
      type(gpu_var_int_class) :: species
      type(gpu_var_int_class) :: neighbor_species
      type(gpu_var_int_class) :: neighbors_list
      type(gpu_var_double_class) :: rjs
      type(gpu_var_double_class) :: xyz
   end type gpu_neigh
   ...
   type gpu_exp
      ...
      type(gpu_var_int_class), allocatable :: nk_d(:)
      type(gpu_var_int_class), allocatable :: k_index_d(:)
      type(gpu_var_int_class), allocatable :: j2_index_d(:)
      type(gpu_var_int_class), allocatable :: nk_flags_d(:)
      type(gpu_var_int_class), allocatable :: nk_sum_flags_d(:)
      type(gpu_var_double_class), allocatable :: xyz_k_d(:)
      type(gpu_var_double_class), allocatable :: pair_distribution_partial_d(:)
      type(gpu_var_double_class), allocatable :: rjs_index_d(:)
      type(gpu_var_double_class), allocatable :: pair_distribution_partial_der_d(:)
      type(gpu_var_double_class) :: pair_distribution_d
      type(gpu_var_double_class) :: Gk_d
      type(gpu_var_double_class) :: Gka_d
      type(gpu_var_double_class) :: fi_d
      type(gpu_var_double_class) :: dermat_d
      type(gpu_var_double_class) :: x_d
      type(gpu_var_double_class) :: dV_d
