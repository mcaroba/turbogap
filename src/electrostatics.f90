...
module electrostatics
    ...
    subroutine compute_coulomb_direct(charges, charge_gradients, &
        ...
        implicit none
        real(dp), dimension(:), intent(in) :: charges, neighbor_charges
        ...
        neigh_offset = 0
        do_gradients = (present(forces) .or. present(virial))
        ...
        do center_i = 1, n_sites
            ...
            do neigh_seq = 1, n_neigh(center_i)
                ...
                pair_energy = 0.5 * center_term * neigh_charges(neigh_id) / rij
                ...
                if do_gradients then
                    ...
                    ! TODO are outer products implemented...?
                    virial = virial + (rij_vec  .outer. rij_vec)
                end if
            end do
