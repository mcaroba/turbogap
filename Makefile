...
SRC := splines.f90 types.f90 neighbors.f90 gap.f90 vdw.f90 xyz.f90 md.f90 read_files.f90 \
       gap_interface.f90 mpi.f90 \
       adaptive_time.f90 electronic_stopping.f90 cubicspline.f90 eph_beta.f90 eph_fdm.f90 \
