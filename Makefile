...
SRC := printing.f90 error.f90 read_utils.f90 timing.f90 misc.f90 electrostatics.f90 constants.f90 gle.f90 ir_auxiliary_dynamics.f90 mad_ir.f90 mad_ir_xl.f90 nonneg_leastsq.f90 splines.f90 types.f90 gpu_context.f90 neighbors.f90 gap.f90 vdw.f90		\
