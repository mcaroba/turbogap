...
SRC_CUDA := cuda_wrappers.cu gpu_exp.cu gpu_sparse.cu
#SRC_CC :=  3b_final.cc # orthonormalization_kernels.cc
SRC := splines.f90 types.f90 neighbors.f90 gap.f90 misc.f90 constants.f90 nonneg_leastsq.f90 vdw.f90 \
       xyz.f90 md.f90 read_files.f90 \
