...
c60_ts = -534.16702364
c60_none = -531.31347119
c60_mbd = -535.84717682
...
plt.figure()
plt.plot(d[12:],ene_none[12:],'r.-',label="GAP+None")
plt.plot(d[12:],ene_ts[12:],'b.-',label="GAP+TS")
plt.plot(d[12:],ene_mbd[12:],'g.-',label="GAP+MBD")
...
ax.plot(d[12:],ene_mbd[12:],'g.-',label="GAP+MBD")
ax.plot(d_dft,ene_dft,'k.-',label="DFT+MBD")
ax.set_xlim([d[12],d[-1]])
