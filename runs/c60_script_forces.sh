...
g="$( bc <<<"$d + 2" )"
echo $d $g
> scs_timing_forces_$d.dat
> communication_timing_forces_$d.dat
> mbd_timing_forces_$d.dat
...
grep "SCS timing" output | awk '{print $3}' >> scs_timing_forces_$d.dat
grep "Communication timing" output | awk '{print $3}' >> communication_timing_forces_$d.dat
grep "MBD timing" output | awk '{print $3}' >> mbd_timing_forces_$d.dat
done
done
