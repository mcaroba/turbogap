#!/usr/bin/env python3
"""Finite-difference check of the MAD forces and virial.
...
def main():
    ...
    # finite difference is only good to a few parts in 1e6. On this branch the
    # matrix force route reduces on the device, whose summation order is not
    # fixed, which adds a little more noise in the last digits -- a leg landing
    # at 1e-5 rather than 1e-8 is resolution, not a missing term.
